...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        return use_search, use_agents, max_refinements
...
def process_generation(use_search, use_agents, max_refinements):
...
def main():
    ...
    use_search, use_agents, max_refinements = render_sidebar()
    ...
    process_generation(use_search, use_agents, max_refinements)
    
    # Footer
    st.markdown("---")
    st.caption("Powered by Google Gemini 2.5 Pro | Multi-Agent Quality Verification System | Thread Mode | Update : Oct 17 7:12 PM")
